...
-- changeset HR:1768820232739 stripComments:false  logicalFilePath:ords/hr/ords.sql
-- sqlcl_snapshot {"hash":"78af2e4822a41de862c2d9e9102ee9a3c4cff9da","type":"ORDS_SCHEMA","name":"ords","schemaName":"HR","sxml":""}
--
...
exception
 ...
 when others then 
  ...
  ORDS.CREATE_ROLE(
      p_role_name=> 'oracle.dbtools.role.autorest.HR');
  ORDS.CREATE_ROLE(
      p_role_name=> 'oracle.dbtools.role.autorest.any.HR');
  l_modules(1) := 'oracle.example.hr';

  ORDS.DEFINE_PRIVILEGE(
      p_privilege_name => 'gf.bankas.apis',
      p_roles          => l_roles,
      p_patterns       => l_patterns,
      p_modules        => l_modules,
      p_label          => 'gf.bankas.apis',
      p_description    => NULL,
      p_comments       => NULL); 
  ...
  l_roles(2) := 'oracle.dbtools.role.autorest.HR';

  ORDS.DEFINE_PRIVILEGE(
      p_privilege_name => 'oracle.dbtools.autorest.privilege.HR',
      p_roles          => l_roles,
      p_patterns       => l_patterns,
      p_modules        => l_modules,
      p_label          => 'HR metadata-catalog access',
      p_description    => 'Provides access to the metadata catalog of the objects in the HR schema.',
      p_comments       => NULL); 
